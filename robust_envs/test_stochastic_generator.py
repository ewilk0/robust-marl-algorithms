import sys
sys.path.append("/Users/ethanwilk/Documents/SusGym/robust-maddpg-code/robust-maddpg-neurips/robust_envs/env")
from env import BuildingEnvModified as BuildingEnv
...
block_size = None # in hours
episode_len = 288 # number of timesteps in each episode
time_res = 300 # resolution in seconds
